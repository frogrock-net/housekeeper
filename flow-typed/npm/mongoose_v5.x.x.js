...
declare class Mongoose$Schema<Doc> {
    ...
    pre(hookType: Mongoose$SchemaHookTypes, true, parallelCb: (next: Function, done: Function) => any): void;
...
declare class Mongoose$Document {
    ...
    static find(criteria?: Object, projection?: MongooseProjection, options?: Object): Mongoose$Query<Array<this>, this>;
    static findById(id: MongoId, projection?: MongooseProjection, options?: Object): Mongoose$Query<?this, this>;
    ...
    static findByIdAndUpdate(id: MongoId, data: Object, options?: Object): Mongoose$Query<?this, this>;
    ...
    static findOneAndUpdate(criteria: ?Object, data: Object, options?: Object): Mongoose$Query<?this, this>;
    static geoSearch(
        conditions: Object,
        opts: {
            near: [number, number],
    ...
    static update(criteria: Object, update: Object, options?: Object): Promise<UpdateResult> & { exec(): Promise<UpdateResult> };
    static updateMany(criteria: Object, update: Object, options?: Object): Promise<UpdateResult> & { exec(): Promise<UpdateResult> };
    static updateOne(criteria: Object, update: Object, options?: Object): Promise<UpdateResult> & { exec(): Promise<UpdateResult> };
...
declare class Mongoose$Query<Result, Doc> extends Promise<Result> {
    ...
    findOneAndRemove(criteria: Object, opts?: { sort?: Object, maxTimeMS?: number, passRawResult?: boolean }): Mongoose$Query<?Doc, Doc>;
    findOneAndUpdate(
        criteria: Object,
        data: Object,
        opts?: {
...
declare class Mongoose$Connection {
    ...
    model<Doc>(name: string | Doc, schema?: Mongoose$Schema<Doc>, collection?: Mongoose$Collection): Class<Doc>;
